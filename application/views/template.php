...
<html lang="en">
  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main" style="margin-top: 50px;">
		...
		<?php
		if (!empty($itemKegiatan[0])) {
			$waktuKegiatan = strtotime($itemKegiatan[0]->waktuMulaiPinjam);
			echo "Nama kegiatan: ".htmlspecialchars($itemKegiatan[0]->kegiatan)."<br>\n";
			echo "Oleh: ".htmlspecialchars($itemKegiatan[0]->penyelenggara)."<br>\n";
			
			echo tanggalIndonesia($waktuKegiatan, true, false);
		}
