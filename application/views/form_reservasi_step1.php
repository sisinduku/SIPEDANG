...
?>
	...
	<form
		action="<?php echo site_url("/ControlReservasi/form_reservasi"); ?>"
		method="post">
		<div class="row">
			<div class="col-md-6 form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" required name="sipedang_namakegiatan"
							class="form-control" id="sipedang_namakegiatan"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" required name="sipedang_pemesan"
							class="form-control" id="sipedang_pemesan"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" required name="sipedang_penyelenggara"
							class="form-control" id="sipedang_penyelenggara"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select name="sipedang_kategori" required class="form-control"
							id="sipedang_kategori" onchange="pilih_tambah_kategori()">
			...
			<div class="col-md-6 form-horizontal">
				<div class="form-group">
					<label class="col-sm-3 control-label"
						for="sipedang_waktupelaksanaan_step1">Pelaksanaan</label>
					<div class="col-sm-9" id="sipedang_ctr_waktupelaksanaan">
						<input type="text" required name="sipedang_waktupelaksanaan"
							class="form-control" id="sipedang_waktupelaksanaan_step1"
							placeholder="Waktu Pelaksanaan"
							value="<?php if (isset($sipedang_daterange)) echo htmlspecialchars($sipedang_daterange);?>" />
						<input type="hidden" name="sipedang_tglmulai"
							id="sipedang_tglmulai_step1"
							value="<?php if (isset($sipedang_tglmulai)) echo htmlspecialchars($sipedang_tglmulai); ?>" />
						<input type="hidden" name="sipedang_tglselesai"
							id="sipedang_tglselesai_step1"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="email" required name="sipedang_email"
							class="form-control" id="sipedang_email"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" required name="sipedang_kontak"
							class="form-control" id="sipedang_kontak"
				...
				<div class="form-group">
					<div class=" col-sm-12">
						...
						<button type="submit" name="sipedang_btnsubmit"
							class="btn btn-primary btn-md btn-block">
							Daftar <span class="glyphicon glyphicon-chevron-right"></span>
						</button>
					</div>
				</div>
			</div>
